...
//           }
//         } else if ((team === 'printing' || team === 'coating') && component.component_type === 'glass') {
//           // For printing and coating teams, check if component has respective decorations and use decoration status
...
//         if ((forPrinting || team === 'printing') && component.component_type === 'glass') {
...
//           );
//         } else if (team === 'coating' && component.component_type === 'glass') {
//           // For coating team, check decoration status
//           if (!component.decorations?.coating) return false;
          
//           const coatingStatus = component.decorations.coating.status;
//           return (
//             (status === 'in_progress' && (coatingStatus === 'IN_PROGRESS' || coatingStatus === 'PENDING')) ||
//             (status === 'ready_to_dispatch' && coatingStatus === 'READY_TO_DISPATCH') ||
//             (status === 'dispatched' && coatingStatus === 'DISPATCHED')
//           );
//         } else {
