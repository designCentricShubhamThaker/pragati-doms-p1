  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="relative bg-red-700 hover:bg-red-800 text-white rounded-sm px-3 py-2 gap-2 shadow-md transition-colors duration-200"
      >
        <Bell size={16} />
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-orange-700 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center animate-pulse">
